      ...
      <div className="space-y-8 text-sm leading-relaxed text-muted-foreground [&_h2]:mb-3 [&_h2]:mt-8 [&_h2]:text-base [&_h2]:font-semibold [&_h2]:text-foreground [&_ul]:mt-2 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-1">
        ...
        <section>
          ...
          <ul>
            <li>
              ...
              <strong className="text-foreground">Kenya Shillings (KES)</strong> and are inclusive
              of applicable taxes.
            </li>
            <li>
            ...
            <li>
              Product images are for illustration purposes. Actual products may differ slightly in
              appearance.
            </li>
            <li>
              We make every effort to display accurate stock information; however, availability is
              not guaranteed until your order is confirmed.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              In the event of a pricing error, we will notify you before processing and give you the
              option to proceed at the correct price or cancel.
            </li>
        ...
        <section>
          ...
          <ul>
            <li>
              We accept <strong className="text-foreground">M-Pesa</strong> and major{" "}
              <strong className="text-foreground">debit/credit cards</strong>.
            </li>
            <li>Payment must be received in full before an order is dispatched.</li>
            <li>
              For M-Pesa payments, use your Order ID as the payment reference. Orders are processed
              once payment is confirmed.
            </li>
            <li>
              We do not store card details; all card transactions are handled by our secure payment
              processor.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            All content on this website — including text, images, logos and software — is owned by
            or licensed to OffGridIt. You may not reproduce or redistribute any content without
            written permission.
          </p>
        </section>
