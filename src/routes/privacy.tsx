  ...
  return (
    <div className="container-px mx-auto max-w-3xl py-14">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8 text-sm leading-relaxed text-muted-foreground [&_h2]:mb-3 [&_h2]:mt-8 [&_h2]:text-base [&_h2]:font-semibold [&_h2]:text-foreground [&_ul]:mt-2 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-1">
        <p>
          OffGridIt ("<strong className="text-foreground">we</strong>", "
          <strong className="text-foreground">us</strong>", "
          <strong className="text-foreground">our</strong>") is committed to protecting your
          personal data in accordance with the{" "}
          <strong className="text-foreground">Kenya Data Protection Act, 2019 (KDPA)</strong> and
          the Data Protection (General) Regulations, 2021. This policy explains what data we
          collect, why we collect it, and your rights as a data subject.
        </p>
        ...
        <section>
          ...
          <p>
            ...
            website. You can reach us via our{" "}
        ...
        <section>
          ...
          <ul>
            <li>
              <strong className="text-foreground">Account data:</strong> email address, display name
            ...
            <li>
              ...
              Card and M-Pesa transactions are processed by third-party payment providers; we do not
              store card numbers
            </li>
            <li>
              <strong className="text-foreground">Usage data:</strong> pages visited, products
              viewed (stored locally on your device)
            </li>
            <li>
        ...
        <section>
          ...
          <ul>
            <li>
              <strong className="text-foreground">Order fulfilment</strong> — to process, deliver
              and support your purchases (contractual necessity)
            </li>
            <li>
              <strong className="text-foreground">Order confirmation emails</strong> — to notify you
              of purchase details (contractual necessity)
            </li>
            <li>
              <strong className="text-foreground">Customer support</strong> — to respond to
              enquiries (legitimate interest)
            </li>
            <li>
              <strong className="text-foreground">Service improvement</strong> — to understand how
              the site is used (legitimate interest)
            </li>
            <li>
              <strong className="text-foreground">Marketing</strong> — newsletter updates, only with
        ...
        <section>
          ...
          <p>
            We retain your personal data for as long as necessary to fulfil the purposes above, or
            as required by law. Order records are retained for 7 years for tax and legal compliance.
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              ...
              consent-based processing (e.g. newsletter)
            </li>
          </ul>
          <p className="mt-2">
            To exercise any right, contact us via the{" "}
            <Link to="/contact" className="text-primary underline">
              Contact page
            </Link>
        ...
        <section>
          <h2>7. Cookies</h2>
          <p>
            We use browser localStorage (not third-party cookies) to store your cart, wishlist, and
            recently viewed products entirely on your device. We do not use advertising or tracking
            cookies.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            security on our database, and restricted access to personal data. However, no system is
        ...
        <section>
          ...
          <p>
            ...
            email or a notice on this website. Continued use of the site after changes constitutes
